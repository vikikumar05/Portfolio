...
$dbname = "if0_38256126_contact_form_portfolioviki";
$username = "if0_38256126";
$password = "oB8CQ8FnC2pTM";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if (mail($to, $email_subject, $email_body, $headers)) {
            ...
            echo json_encode(["success" => true, "message" => "Message stored but email not sent"]);
        }
